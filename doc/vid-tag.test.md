...
The test data archive `vid-tag-test-input.zip` must exist in the
current directory; it is unzipped during oneTimeSetUp and supplies
three video files plus a sample `vid-tag.conf`.
...
- **-T "pTest"**
    ...
    "**-T list**" lists all test function names.

    "**-T com**" runs all tests for bash-com.inc.
